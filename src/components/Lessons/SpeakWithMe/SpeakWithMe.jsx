...
function SpeakWithMe() {
  // 1. جلب البيانات من Context بلاصة Firebase
  ...
  // 3. تحديد الرتبة والاسم من userData اللي جا من Context
  const role = userData?.role?.toLowerCase() || 'free';
  const name = userData?.name || 'زائر';
