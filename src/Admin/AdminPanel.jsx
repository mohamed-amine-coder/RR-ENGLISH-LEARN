...
//   FaPhone, FaWhatsapp, FaChartPie, FaCrown 
// } from 'react-icons/fa';
...
//           ...data,
//           role: data.role || 'free',
//           gender: data.gender || 'unknown', // 🟢 استرجاع الجنس
...
//     handleChange(userId, 'role', 'premium'); // تفعيل تلقائي
...
//             <span className={styles.male}><FaMars /> {stats.males}</span>
//             <span className={styles.sep}>|</span>
//             <span className={styles.female}><FaVenus /> {stats.females}</span>
//           </div>
//           <p>الجنس</p>
//         </div>

//         {/* Plan Stats */}
//         <div className={`${styles.statBox} ${styles.plansBox}`}>
//           <div className={styles.planStat}>
//             <span className={styles.dotStart}></span> Start: <strong>{stats.plans.start}</strong>
//           </div>
//           <div className={styles.planStat}>
//             <span className={styles.dotPro}></span> Pro: <strong>{stats.plans.pro}</strong>
//           </div>
//           <div className={styles.planStat}>
//             <span className={styles.dotTurbo}></span> Turbo: <strong>{stats.plans.turbo}</strong>
//           </div>
//         </div>

//         {/* Revenue/Active */}
//         <div className={styles.statBox} style={{borderColor: '#25D366'}}>
//           <div className={styles.statIcon} style={{color: '#25D366'}}><FaCrown /></div>
//           <div>
//             <h3>{stats.premium}</h3>
//             <p>مشترك نشط</p>
//           </div>
...
//             <input 
//               type="text" 
//               placeholder="بحث بالاسم، الهاتف، أو المجموعة..." 
//               value={searchTerm}
//               onChange={(e) => setSearchTerm(e.target.value)}
//             />
//           </div>
//           <button className={styles.refreshBtn} onClick={fetchUsers}>🔄 تحديث</button>
//         </div>
...
//             <thead>
//               <tr>
//                 <th width="20%">الهوية & الجنس</th>
//                 <th width="20%">التواصل</th>
//                 <th width="30%">تفاصيل الاشتراك (Plan & Time)</th>
...
//                 return (
//                   <tr key={user.id} className={isActive ? styles.activeRow : ''}>
                    
//                     {/* 1. الهوية (الاسم، الجنس، الايميل) */}
//                     <td>
...
//                             value={user.gender}
//                             onChange={(e) => {
//                               handleChange(user.id, 'gender', e.target.value);
//                               updateDbField(user.id, 'gender', e.target.value);
//                             }}
//                             className={`${styles.genderSelect} ${user.gender === 'female' ? styles.isFemale : styles.isMale}`}
//                           >
//                             <option value="male">♂️</option>
//                             <option value="female">♀️</option>
//                             <option value="unknown">?</option>
//                           </select>
//                           <span className={styles.userName}>{user.name || 'مجهول'}</span>
//                         </div>
//                         <span className={styles.userEmail}>{user.email}</span>
//                       </div>
//                     </td>

//                     {/* 2. التواصل (الهاتف، واتساب) */}
//                     <td>
...
//                           />
//                           {user.phoneNumber && (
//                             <a href={`https://wa.me/${user.phoneNumber.replace('+','')}`} target="_blank" className={styles.waIcon}>
//                               <FaWhatsapp />
//                             </a>
//                           )}
//                         </div>
...
//                     {/* 3. الاشتراك (الباقة، المجموعة، التاريخ) */}
//                     <td>
...
//                             value={user.planType}
//                             onChange={(e) => {
//                               handleChange(user.id, 'planType', e.target.value);
//                               updateDbField(user.id, 'planType', e.target.value);
//                             }}
//                             className={`${styles.planSelect} ${styles[user.planType]}`}
//                           >
...
//                             onChange={(e) => {
//                               handleChange(user.id, 'subscriptionEndDate', e.target.value);
//                               updateDbField(user.id, 'subscriptionEndDate', e.target.value);
//                             }}
//                             className={styles.dateInput}
//                           />
//                           <button className={styles.renewBtn} onClick={() => quickRenew(user.id)} title="+30 يوم">
//                             +30 يوم
//                           </button>
//                         </div>
//                       </div>
...
//                             updateDbField(user.id, 'role', e.target.value);
//                           }}
...
//                       <button className={styles.deleteBtn} onClick={() => handleDeleteUser(user.id, user.name)}>
//                         <FaTrash />
//                       </button>
//                     </td>
